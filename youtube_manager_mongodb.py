...
client = MongoClient("mongodb+srv://youtubepy:youtubepy@cluster0.cudmnsv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", tlsAllowInvalidCertificates=True)
